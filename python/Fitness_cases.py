...
problem_dir = 'Equal Stiffness\\' # Equal Stiffness, Artery ,Assign, Partition, (C1_DTLZ1, Simple DTLZ1_2, UF1 are test problems)
...
case_booleans['All Heurs.'] = [True for i in range(len(heuristic_names))] # All heuristics enforced
#if problem_dir == 'Equal Stiffness\\' or problem_dir == 'Artery\\':
