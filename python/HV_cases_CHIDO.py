...
case_bools['Base'] = coev_pen_bools # No modifications
coev_pen_wow_bools.append(2)
case_bools['WoW'] = coev_pen_wow_bools # Weight of weights
#coev_pen_pzi_bools.append(3)
#case_bools['PZI'] = coev_pen_pzi_bools # Periodic zero injection

plot_colors = {} # black, yellow, blue for Eps. MOEA, AOS & Coev. Penalty respectively
plot_colors['Base'] = '#000000'
plot_colors['WoW'] = '#E69F00'
#plot_colors['PZI'] = '#56B4E9'
